...
<div class="relative  place-content-center ">
  ...
  <div class="place-content-center absolute inset-x-1/2 bottom-96">
    <div class="left-96">
      <Button
        href="/about" 
        class="py-4 px-5 mt-12 -ml-10 text-xl font-semibold bg-yellow-300 hover:bg-yellow-200 focus:ring-yellow-100"
        >About</Button
      >
    </div>
  </div>
  <div class="-mt-10 ml-0 h-max bg-inherit hover:bg-inherit rounded-lg place-content-center">
    <Button target="self"
